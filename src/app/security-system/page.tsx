...
import wirelessImage1 from "@/assests/img/wireless.avif";
  ...
  return (
    <>
      ...
      <div className="relative flex h-[70vh] pt-32 content-center items-center justify-center pt-16 pb-32">
        <div className="absolute top-0 h-[70vh] w-full bg-[url('/images/security-bg.jpg')] bg-cover bg-center" />
          ...
          <div className="flex flex-wrap items-center">
            <div className="ml-auto mr-auto w-full px-4 text-center lg:w-8/12">
              ...
              <Typography
                ...
                onPointerLeaveCapture={undefined}
              >
                Revolutionize your business communication with Wire Wave’s Wireless Technology
      ...
      {/* Wireless Technology Overview Section */}
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                <Image
                  alt="Wireless Technology Solutions"
                  src={wirelessImage1}
              ...
              >
                ...
                <Typography
                  ...
                  onPointerLeaveCapture={undefined}
                >
                  Voice Over Internet Protocol (Wireless Technology) has transformed how
            ...
            <div>
              ...
              <Typography
                ...
                onPointerLeaveCapture={undefined}
              >
                Why Wire Wave Wireless Technology?
              </Typography>
              <Typography
                ...
                onPointerLeaveCapture={undefined}
              >
                The internet revolutionized communication, and Wireless Technology is at the
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="container mx-auto">
          <PageTitle
            section="Wireless Technology Features"
            heading="Advanced Tools for Modern Businesses"
          >
            Our Wireless Technology solutions are designed to meet the demands of today’s
            ...
            >
              ...
              >
                ...
                <Typography
                  ...
                  onPointerLeaveCapture={undefined}
                >
                  Our team is available round-the-clock to keep your Wireless Technology system
            ...
            >
              ...
              >
                ...
                <Typography
                  ...
                  onPointerLeaveCapture={undefined}
                >
                  Integrate Wireless Technology effortlessly with your existing network
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          <PageTitle section="Benefits" heading="Why Wireless Technology with Wire Wave?">
            From startups to large enterprises, our Wireless Technology services deliver
          ...
          <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    affordable Wireless Technology plans.
                  </Typography>
                </ListItem>
                <ListItem
                  className="p-0 mb-4"
            ...
            >
              ...
              >
                <Image
                  alt="Wireless Technology Benefits"
                  src={voipImage2}
                  className="h-full w-full object-cover"
                  width={600}
                  height={400}
              ...
              >
                ...
                <Typography
                  ...
                  onPointerLeaveCapture={undefined}
                >
                  As remote work becomes the norm, our Wireless Technology solutions provide
      ...
      <section className="py-20 px-4 bg-blue-gray-900 text-white">
        <div className="container mx-auto text-center">
          ...
          <Typography
            ...
            onPointerLeaveCapture={undefined}
          >
            Join the Wireless Technology revolution with Wire Wave. Contact us to explore how
